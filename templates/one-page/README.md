...
{% include ".gitbook/includes/one-page-teaching-goals.md" %}

## Learning Outcomes

{% include ".gitbook/includes/one-page-learning-outcomes.md" %}
...
{% include ".gitbook/includes/one-page-co-requisite-courses.md" %}
